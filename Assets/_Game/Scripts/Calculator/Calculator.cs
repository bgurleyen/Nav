...
public class Calculator : MonoBehaviour
{
    ...
    private double[,,,] Mf = new double[9, 5, 4, 4] {{
        ...
        //f2
        {
        { { 240, 100,7250,268 }, { -500, 0, 3670,95 } , { 180, 500,6580,234 }, { -200, 300, 3370,95 } },
        { { 240, 100,7250,268 }, { -500, 0, 3670,95 } , { 180, 500,6580,234 }, { -200, 300, 3370,95 } },
        { { 240, 100,6800,266 }, { -500, 0, 3350,95 } , { 180, 400,6340,242 }, {-200, 300, 3250,95 } },
        { { 240, 100,6540,268 }, { -500, 0, 3240,95 } , { 180, 400,5970,229 }, { -200,300, 3150,95 } },
        { { 240, 100,6270,265 }, { -500, 0, 3140,95 } , { 180, 150,5630,233 }, { -200, 300, 3060,95 } } },
        //f5
        {
