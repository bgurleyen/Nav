...
public static class LevelsLayoutSpec
{
    ...
    public const float SideLabelWidth = 96f;
    public const float SideGap = 16f;
    ...
    public const float CellFont = 15f * FontScale;
    public const float SideLabelFont = 28f * FontScale;
    public const float SideLabelSpacing = 0.22f * SideLabelFont;
