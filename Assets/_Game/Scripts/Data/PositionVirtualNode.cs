...
public class PositionVirtualNode
{
    ...
    public static int PassedNodeIndex => Session.PlayerAircraft.RoutePathLocalization.CurrentNodeIndex - 1;
    public static int PassedNodeIndexForMode => Session.PlayerAircraft.IsOnRoute 
        ? Session.PlayerAircraft.RoutePathLocalization.CurrentNodeIndex - 1 
        : 0;
