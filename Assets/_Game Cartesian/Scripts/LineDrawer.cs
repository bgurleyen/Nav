            ...
            switch (cacheLine)
            {
                case DoubleCurve doubleCurve:
                    ...
                    Gizmos.DrawWireSphere(pos + doubleCurve.O1.ToDisplay(),
                        GameSettingsScriptableObject.GetMinRadius * 1);
                    Gizmos.color = Color.blue;
                    Gizmos.DrawWireSphere(pos + doubleCurve.o2.ToDisplay(),
                        GameSettingsScriptableObject.GetRelaxedRadius * 1);
                ...
                case Curve curve:
                    Gizmos.color = Color.green;
                    Gizmos.DrawWireSphere(pos + curve.O1.ToDisplay(), curve.CachedRadius * 1);
                    break;
            }
        }
    }
